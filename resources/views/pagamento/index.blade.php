                    ...
                    <div class="col-md-12">
                        <div class="p-5 mb-4 bg-light rounded-3">
                            <div class="container-fluid py-5">
                                ...
                                <p class="col-md-8 fs-4">Seu histórico de transações está vazio. Para efetuar investimentos nas exibições de produto é necessário adicionar créditos.<a href="{{route('pagamento.create')}}">Clique aqui</a> para adicionar créditos.</p>
                            </div>
                        </div>
                    </div>
                @endif
